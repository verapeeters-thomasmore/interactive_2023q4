const pricePerParticipant = (participants, totalCostForWorkshop, minParticipants, maxParticipants) => {
    return participants < minParticipants ? -1 : Math.max(totalCostForWorkshop / Math.min(participants, maxParticipants), 20);
};
