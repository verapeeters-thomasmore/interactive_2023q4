function pricePerParticipant(participants, totalCostForWorkshop, minParticipants=1, maxParticipants=20) {
...
console.log("extra gevallen: ")
console.log(pricePerParticipant(10, 1000)); //100
console.log(pricePerParticipant(20, 1000, undefined, 10)); //100 because no more than 10 participants
console.log(pricePerParticipant(10, 1000, 20)); //-1 because less then 20 participants
