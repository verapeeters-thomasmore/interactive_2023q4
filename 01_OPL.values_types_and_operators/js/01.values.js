...
console.log("======================================");
console.log("=== Oefeningen sprookje");
const message = "Dit is een \"sprookje\"\n" +
    "Ik bedoel: \n" +
    "\t- geen COVID \n" +
    "\t- geen feest";
console.log(message);

console.log("=== Oefeningen BMI");
const weightInKg = 80;
const lengthImM = 1.80;
console.log(`BMI: ${weightInKg / (lengthImM ** 2)}`);

console.log("=== Oefeningen ondergewicht en bovengewicht");
console.log(`BMI: ${weightInKg / (lengthImM ** 2) < 25 ? "ondergewicht of normaal gewicht" : "overgewicht of obesitas"}`);
